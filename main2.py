...
class Board:
    ...
    def __init__(self):
        ...
        self.allowed_places = ((+1,0),(0,+1),(-1,0),(0,-1),(0,0),(0,-2),(+2,0),(0,+2),(-2,0))
...
class Warship:
    def __init__(self,number_of_tails):
...
#    print (x,y,board1.forbidden_offsets)
    i+=1    
    print  (board1)
...
for _ in range(3):
    ...
    while i<2 :
        x = int(input("x(0-9):  "))
        y = int(input("y(0-9):  "))
        for allows in board1.allowed_places:
            xo, yo = allows
