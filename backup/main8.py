...
while i < 3:
    ...
    if placement == "h":
        if (x, y) in board1.forbiden_fields or (x + 1, y + 0) in board1.forbiden_fields:
            print("alredy used, or forbiden")
            continue
        board1.state[y][x] = "2"
        ...
        for offsets in board1.forbidden_offsets_2_v:
            xo, yo = offsets
            board1.forbiden_fields.add((x + xo, y + yo, x + xo + 1))
    elif placement == "v":
        if (x, y) in board1.forbiden_fields or (x + 0, y + 1) in board1.forbiden_fields:
            print("alredy used, or forbiden")
            continue
        board1.state[y][x] = "2"
        ...
        for offsets in board1.forbidden_offsets_2_h:
            xo, yo = offsets
            board1.forbiden_fields.add((x + xo, y + yo, y + yo + 1))
...
while i < 2:
    ...
    if placement == "h":
        ...
        for offsets in board1.forbidden_offsets_3_v:
            xo, yo = offsets
            board1.forbiden_fields.add((x + xo, y + yo, x + xo + 1, x + xo + 2))
    elif placement == "v":
        if (x, y) in board1.forbiden_fields or (
            x + 0,
            y + 1,
        ...
        for offsets in board1.forbidden_offsets_3_h:
            xo, yo = offsets
            board1.forbiden_fields.add((x + xo, y + yo, y + yo + 1, y + yo, y + yo + 2))
